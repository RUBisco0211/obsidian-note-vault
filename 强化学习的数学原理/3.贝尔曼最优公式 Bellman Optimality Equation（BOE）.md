---
title: 3.贝尔曼最优公式 Bellman Optimality Equation（BOE）
created: 2025-07-05 08:52:08
updated: 2025-11-29 10:52:20
---
## 最优策略
...
即为对应策略$\pi^*$的贝尔曼公式，故$v^* = v_{\pi^*}$，最优状态值实际上是最优策略下的对应状态值，**贝尔曼最优公式实际上是特殊的[[2.贝尔曼公式 Bellman Equation|贝尔曼公式]]**
