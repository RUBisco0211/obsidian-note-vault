---
title: 8.值函数近似 Value Function Approximation (VFA)
created: 2025-07-05 09:27:26
updated: 2025-11-29 10:48:39
---
## 从离散表示到连续表示
...
其中$P_{\pi}$为策略$\pi$下MDP的[[2.贝尔曼公式 Bellman Equation#^StateTransferMatrix|状态转移矩阵]]，$[P_{\pi}]_{ij} = p_{\pi}\{ s'=s_{j} | s=s_{i} \}$
...
> 把$e_{s}$代入**TD-Linear**，即为[[7.时序差分方法 Temporal-Difference Learning（TD learning）#TD Basic：学习状态值|TD Basic方法]]（仅更新$s_{t}$的状态值，其他不变）
> 
