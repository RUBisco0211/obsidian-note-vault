---
title: 5.基于蒙特卡洛的方法 Monte-Carlo Methods（model-free）
created: 2025-07-05 09:10:08
updated: 2025-11-29 10:52:15
---
## 概述
...
基本思想：将[[4.基于模型的（model-based）BOE求解方法#策略迭代 policy iteration (PI)|策略迭代]]中依赖模型，即计算动作值$q(s,a)$的部分进行替换
...
$$
- **不依赖模型：[[2.贝尔曼公式 Bellman Equation#动作值 Action value#定义|动作值的原始定义]]**
$$
