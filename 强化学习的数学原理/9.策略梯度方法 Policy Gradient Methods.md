---
title: 9.策略梯度方法 Policy Gradient Methods
created: 2025-07-05 09:32:41
updated: 2025-11-29 10:44:26
---
## 从基于值的方法到基于策略的方法
...
**第二种情况：** $d$依赖于$\pi$
- [[8.值函数近似 Value Function Approximation (VFA)#稳态分布 stationary distribution| 稳态分布 stationary distribution]]：$d = d_{\pi}$
...
其中$S \sim d_{\pi}$，$d_{\pi}$为[[8.值函数近似 Value Function Approximation (VFA)#稳态分布 stationary distribution| 稳态分布]]，依赖于策略$\pi$。且其中
...
- [[5.基于蒙特卡洛的方法 Monte-Carlo Methods（model-free）|Monte-Carlo]] 方法：从$(s,a)$出发得到一个trajectory的数据来估计动作值，这种方法即为**REINFORCE**
- [[7.时序差分方法 Temporal-Difference Learning（TD learning）|TD]]方法：此种方法为[[10.演员-评论家方法 Actor-Critic Methods|Actor-Critic]]
### 如何采样
