...
var DEFAULT_SETTINGS = {
  ...
  // 保持当前默认行为
  previewCommand: "npm run docs:preview",
  // 保持当前默认行为
...
var SettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  configBasicSetting() {
    ...
    new import_obsidian.Setting(containerEl).setName(instance.t("vitepress-folder-path")).setDesc(instance.t("vitepress-folder-path-desc")).addText((text) => {
    ...
    new import_obsidian.Setting(containerEl).setName(instance.t("vitepress-srcDir-path")).setDesc(instance.t("vitepress-srcDir-path-desc")).addText((text) => {
      text.inputEl.classList.add("vitepress-setting-max-width");
...
${this.plugin.settings.needCleanDirFolder ? `- ${instance.t("plugin-action-tip-clean-dir")}` : ""}${this.plugin.settings.vitepressStaticDir ? `- ${instance.t("plugin-action-tip-move-to-src-dir")}` : ""}- ${instance.t("plugin-action-tip-public-move-to-src-dir")}${this.plugin.settings.ignoreFileRegex ? `(${instance.t("plugin-action-tip-filter-by-regex", { regex: `${this.plugin.settings.ignoreFileRegex}` })})` : ""}`, ["vitepress-setting-warningtext"]);
  ...
  configCommandSettings() {
    const { containerEl } = this;
    new import_obsidian.Setting(containerEl).setName(instance.t("command-configuration")).setDesc(instance.t("command-configuration-desc")).addToggle((toggle) => toggle.setValue(this.plugin.settings.enableCustomCommands || false).onChange(async (value) => {
      this.plugin.settings.enableCustomCommands = value;
      await this.plugin.saveData(this.plugin.settings);
      this.display();
    }));
    if (this.plugin.settings.enableCustomCommands) {
      new import_obsidian.Setting(containerEl).setName(instance.t("vitepress-commands")).setHeading();
      new import_obsidian.Setting(containerEl).setName("").setDesc(instance.t("command-support-desc"));
      new import_obsidian.Setting(containerEl).setName(instance.t("dev-command")).setDesc(instance.t("dev-command-desc")).addText((text) => text.setPlaceholder("npm run docs:dev").setValue(this.plugin.settings.devCommand || "npm run docs:dev").onChange(async (value) => {
        this.plugin.settings.devCommand = value || "npm run docs:dev";
        await this.plugin.saveData(this.plugin.settings);
      }));
      new import_obsidian.Setting(containerEl).setName(instance.t("build-command")).setDesc(instance.t("build-command-desc")).addText((text) => text.setPlaceholder("npm run docs:build").setValue(this.plugin.settings.buildCommand || "npm run docs:build").onChange(async (value) => {
        this.plugin.settings.buildCommand = value || "npm run docs:build";
        await this.plugin.saveData(this.plugin.settings);
      }));
      new import_obsidian.Setting(containerEl).setName(instance.t("preview-command")).setDesc(instance.t("preview-command-desc")).addText((text) => text.setPlaceholder("npm run docs:preview").setValue(this.plugin.settings.previewCommand || "npm run docs:preview").onChange(async (value) => {
...
var VitepressCommand = class {
  ...
  async build() {
    ...
    const childProcess2 = child_process.spawn(buildCommand, buildArgs, this.getSpawnOptions());
  ...
  async startPreview(openBrowserOnStart, finish = null) {
    if (!this.checkSetting()) {
      return;
    }
    this.consoleModal.open();
  ...
  async docsPrepare() {
    ...
    const basePath = this.app.vault.adapter.basePath;
    if (path4.resolve(basePath) === path4.resolve(vitepressSrcDir)) {
      this.consoleModal.appendLogResult(`${actionName} Source and destination directories are the same, operation cancelled for safety`, 1 /* Warning */);
      new import_obsidian3.Notice("Source and destination directories are the same, operation cancelled for safety");
      return true;
    }
  ...
  async copyToVitepressSrc(relativeFile, isCopyDir = false) {
    const basePath = this.app.vault.adapter.basePath;
    if (path4.resolve(basePath) === path4.resolve(this.plugin.settings.vitepressSrcDir)) {
...
__export(en_exports, {
  ...
  "build-command-desc": () => build_command_desc,
  "clean-src-dir": () => clean_src_dir,
  "clean-src-dir-desc": () => clean_src_dir_desc,
  "command-configuration": () => command_configuration,
  "command-configuration-desc": () => command_configuration_desc,
  "command-support-desc": () => command_support_desc,
  default: () => en_default,
  "dev-command": () => dev_command,
  "dev-command-desc": () => dev_command_desc,
  "enter-regex": () => enter_regex,
  "file-not-existed-check": () => file_not_existed_check,
  "filter-doc": () => filter_doc,
  "filter-doc-desc": () => filter_doc_desc,
  "filter-example": () => filter_example,
  ...
  "preview-command-desc": () => preview_command_desc,
  ...
  "publish-script-example": () => publish_script_example,
  "publish-script-not-set": () => publish_script_not_set,
  "publish-setting": () => publish_setting,
  "vitepress-commands": () => vitepress_commands,
  ...
  "vitepress-folder-path-desc": () => vitepress_folder_path_desc,
  "vitepress-srcDir-path": () => vitepress_srcDir_path,
  "vitepress-srcDir-path-desc": () => vitepress_srcDir_path_desc,
...
var publish_script_desc = "Path to deployment script that publishes your built website to server. Can be absolute path or relative to VitePress project directory.";
var publish_script_example = "Example: ./deploy.sh or /Users/username/scripts/deploy.sh";
var publish_script_not_set = "Deploy script path not set";
var vitepress_folder_path = "VitePress Project Root Directory";
var vitepress_folder_path_desc = "Path to your VitePress project root (folder containing package.json). The plugin will execute build and preview commands in this directory.";
var publish_content = "Publish content";
var publish_content_desc = "Choose which folders or files from your Obsidian vault to sync to VitePress. Supports multiple selections - only selected content will be copied on startup. Leave empty to copy nothing on startup (but modified files will still sync in development mode).";
var vitepress_srcDir_path = "VitePress Source Directory (srcDir)";
var vitepress_srcDir_path_desc = "Directory where VitePress reads Markdown files. Your Obsidian content will be synced here, typically 'docs' or 'src' folder under project root.";
var vitepress_srcDir_path_not_set = "Vitepress srcDir path not set";
var need_absolute_path = "Please enter the complete absolute path (e.g., /Users/username/projects/vitepress)";
var path_example = "Example: /Users/john/Documents/my-blog";
var adv_settings = "Advanced settings";
var clean_src_dir = "Clear srcDir directory before executing the command";
var clean_src_dir_desc = "Clear target directory before each sync. Recommended to avoid leftover files, but will delete all existing content in the target directory.";
var vitepress_fixed_dir = "Vitepress fixed directory";
var vitepress_fixed_dir_desc = "Path to directory outside your Obsidian vault. All files in this directory will be automatically copied to VitePress publish directory on each sync, merging with your Obsidian content.";
var filter_doc = "Filter obsidian files or directories";
var filter_doc_desc = "Use regex to exclude files you don't want to sync. Example: 'tmp|draft' will ignore files containing tmp or draft. Leave empty to sync all files.";
var filter_example = "Example: 'private|draft' excludes files containing these words";
...
var auto_sync_md_desc = "Automatically watch for Obsidian file changes and sync to VitePress in development mode. Disable this to require manual refresh to see changes.";
var parser_dataview = 'Parsing "dataview"';
var parser_dataview_desc = "Convert Dataview code blocks to Dataview processing results. Requires Dataview plugin to be installed.";
var parser_dataviewjs = "Parsing dataviewjs (experimental feature)";
var parser_dataviewjsdesc = "Experimental feature: Convert DataviewJS code blocks to DataviewJS processing results. Requires Dataview plugin to be installed. Note: DOM operations (like dv.span, dv.paragraph) are not supported, only data queries.";
var command_configuration = "Custom Commands";
var command_configuration_desc = "Customize build commands, defaults to VitePress, but can be replaced with Hugo, Hexo and other static site generators. Keep default settings if you're not familiar with command line.";
var vitepress_commands = "Custom Command Settings";
var dev_command = "Development command";
var dev_command_desc = "Command to start local preview server. Default: npm run docs:dev";
var build_command = "Build command";
var build_command_desc = "Command to generate static website files for server deployment. Default: npm run docs:build";
var preview_command = "Preview command";
var preview_command_desc = "Command to preview built website before publishing. Default: npm run docs:preview";
var command_support_desc = "Supports other static site generators. Provide full executable path with arguments.\nExamples:\n\u2022 Hugo: /opt/homebrew/bin/hugo serve\n\u2022 Hexo: npx hexo server\n\u2022 Docusaurus: npm start";
var en_default = {
  "basic-setting": basic_setting,
  "folder-setting": folder_setting,
  "publish-setting": publish_setting,
...
__export(zh_cn_exports, {
  ...
  "build-command": () => build_command2,
  "build-command-desc": () => build_command_desc2,
  "clean-src-dir": () => clean_src_dir2,
  "clean-src-dir-desc": () => clean_src_dir_desc2,
  "command-configuration": () => command_configuration2,
  "command-configuration-desc": () => command_configuration_desc2,
  "command-support-desc": () => command_support_desc2,
  default: () => zh_cn_default,
  "dev-command": () => dev_command2,
  "dev-command-desc": () => dev_command_desc2,
  ...
  "filter-example": () => filter_example2,
  ...
  "preview-command": () => preview_command2,
  "preview-command-desc": () => preview_command_desc2,
  ...
  "publish-script-example": () => publish_script_example2,
  "publish-script-not-set": () => publish_script_not_set2,
  "publish-setting": () => publish_setting2,
  "vitepress-commands": () => vitepress_commands2,
  ...
  "vitepress-folder-path-desc": () => vitepress_folder_path_desc2,
  "vitepress-srcDir-path": () => vitepress_srcDir_path2,
  "vitepress-srcDir-path-desc": () => vitepress_srcDir_path_desc2
});
var basic_setting2 = "\u57FA\u672C\u8BBE\u7F6E";
var folder_setting2 = "\u76EE\u5F55\u8BBE\u7F6E";
var publish_setting2 = "\u53D1\u5E03\u8BBE\u7F6E";
var publish_script2 = "\u53D1\u5E03\u811A\u672C";
var publish_script_desc2 = "\u90E8\u7F72\u811A\u672C\u6587\u4EF6\u7684\u8DEF\u5F84\uFF0C\u7528\u4E8E\u5C06\u6784\u5EFA\u597D\u7684\u7F51\u7AD9\u53D1\u5E03\u5230\u670D\u52A1\u5668\u3002\u53EF\u4EE5\u662F\u7EDD\u5BF9\u8DEF\u5F84\u6216\u76F8\u5BF9\u4E8E VitePress \u9879\u76EE\u7684\u76F8\u5BF9\u8DEF\u5F84\u3002";
var publish_script_example2 = "\u793A\u4F8B\uFF1A./deploy.sh \u6216 /Users/\u7528\u6237\u540D/scripts/deploy.sh";
var publish_script_not_set2 = "\u672A\u8BBE\u7F6E\u90E8\u7F72\u811A\u672C\u7684\u8DEF\u5F84";
var vitepress_folder_path2 = "VitePress \u9879\u76EE\u6839\u76EE\u5F55";
var vitepress_folder_path_desc2 = "\u6307\u5411\u4F60\u7684 VitePress \u9879\u76EE\u6839\u76EE\u5F55\uFF08\u5305\u542B package.json \u7684\u6587\u4EF6\u5939\uFF09\u3002\u63D2\u4EF6\u5C06\u5728\u6B64\u76EE\u5F55\u6267\u884C\u6784\u5EFA\u548C\u9884\u89C8\u547D\u4EE4\u3002";
var publish_content2 = "\u53D1\u5E03\u5185\u5BB9";
var publish_content_desc2 = "\u9009\u62E9 Obsidian \u5E93\u4E2D\u8981\u540C\u6B65\u5230 VitePress \u7684\u6587\u4EF6\u5939\u6216\u6587\u4EF6\u3002\u652F\u6301\u591A\u9009\uFF0C\u53EA\u6709\u9009\u4E2D\u7684\u5185\u5BB9\u4F1A\u5728\u542F\u52A8\u65F6\u590D\u5236\u5230\u7F51\u7AD9\u3002\u7559\u7A7A\u5219\u542F\u52A8\u65F6\u4E0D\u590D\u5236\u4EFB\u4F55\u5185\u5BB9\uFF08\u4F46\u5F00\u53D1\u6A21\u5F0F\u4E0B\u4FEE\u6539\u7684\u6587\u4EF6\u4ECD\u4F1A\u5B9E\u65F6\u540C\u6B65\uFF09\u3002";
var vitepress_srcDir_path2 = "VitePress \u6E90\u6587\u4EF6\u76EE\u5F55 (srcDir)";
var vitepress_srcDir_path_desc2 = "VitePress \u8BFB\u53D6 Markdown \u6587\u4EF6\u7684\u76EE\u5F55\u3002Obsidian \u7684\u5185\u5BB9\u5C06\u540C\u6B65\u5230\u8FD9\u91CC\uFF0C\u901A\u5E38\u662F\u9879\u76EE\u6839\u76EE\u5F55\u4E0B\u7684 'docs' \u6216 'src' \u6587\u4EF6\u5939\u3002";
var need_absolute_path2 = "\u8BF7\u586B\u5199\u5B8C\u6574\u7684\u7EDD\u5BF9\u8DEF\u5F84\uFF08\u5982 /Users/\u7528\u6237\u540D/\u9879\u76EE/vitepress\uFF09";
var path_example2 = "\u793A\u4F8B\uFF1A/Users/zhang/Documents/my-blog";
var adv_settings2 = "\u9AD8\u7EA7\u8BBE\u7F6E";
var clean_src_dir2 = "\u6267\u884C\u547D\u4EE4\u65F6,\u5148\u6E05\u7A7AsrcDir\u76EE\u5F55";
var clean_src_dir_desc2 = "\u6BCF\u6B21\u540C\u6B65\u524D\u6E05\u7A7A\u76EE\u6807\u76EE\u5F55\u3002\u63A8\u8350\u5F00\u542F\u4EE5\u907F\u514D\u65E7\u6587\u4EF6\u6B8B\u7559\uFF0C\u4F46\u4F1A\u5220\u9664\u76EE\u6807\u76EE\u5F55\u4E2D\u7684\u6240\u6709\u73B0\u6709\u5185\u5BB9\u3002";
var vitepress_fixed_dir2 = "vitepress\u7684\u56FA\u5B9A\u6587\u4EF6\u76EE\u5F55";
var vitepress_fixed_dir_desc2 = "\u6307\u5411 Obsidian \u5E93\u5916\u90E8\u7684\u76EE\u5F55\u3002\u6B64\u76EE\u5F55\u4E2D\u7684\u6240\u6709\u6587\u4EF6\u4F1A\u5728\u6BCF\u6B21\u540C\u6B65\u65F6\u81EA\u52A8\u590D\u5236\u5230 VitePress \u53D1\u5E03\u76EE\u5F55\uFF0C\u4E0E Obsidian \u5185\u5BB9\u5408\u5E76\u3002";
var filter_doc2 = "\u8FC7\u6EE4obsidian\u6587\u4EF6\u6216\u76EE\u5F55";
var filter_doc_desc2 = "\u4F7F\u7528\u6B63\u5219\u8868\u8FBE\u5F0F\u6392\u9664\u4E0D\u60F3\u540C\u6B65\u7684\u6587\u4EF6\u3002\u4F8B\u5982\uFF1A'tmp|draft' \u4F1A\u5FFD\u7565\u5305\u542B tmp \u6216 draft \u7684\u6587\u4EF6\u3002\u7559\u7A7A\u5219\u540C\u6B65\u6240\u6709\u6587\u4EF6\u3002";
var filter_example2 = "\u793A\u4F8B\uFF1A'private|\u8349\u7A3F' \u6392\u9664\u5305\u542B\u8FD9\u4E9B\u8BCD\u7684\u6587\u4EF6";
...
var auto_sync_md_desc2 = "\u5F00\u53D1\u6A21\u5F0F\u4E0B\u81EA\u52A8\u76D1\u542C Obsidian \u6587\u4EF6\u53D8\u5316\u5E76\u540C\u6B65\u5230 VitePress\u3002\u5173\u95ED\u6B64\u9009\u9879\u9700\u8981\u624B\u52A8\u5237\u65B0\u624D\u80FD\u770B\u5230\u66F4\u6539\u3002";
var parser_dataview2 = "\u89E3\u6790dataview";
var parser_dataview_desc2 = "\u5C06 Dataview \u4EE3\u7801\u5757\u8F6C\u6362\u4E3A Dataview \u5904\u7406\u7ED3\u679C\u3002\u9700\u8981\u5148\u5B89\u88C5 Dataview \u63D2\u4EF6\u3002";
var parser_dataviewjs2 = "\u89E3\u6790dataviewjs(\u5B9E\u9A8C\u6027\u529F\u80FD)";
var parser_dataviewjsdesc2 = "\u5B9E\u9A8C\u6027\u529F\u80FD\uFF1A\u5C06 DataviewJS \u4EE3\u7801\u5757\u8F6C\u6362\u4E3A DataviewJS \u5904\u7406\u7ED3\u679C\u3002\u9700\u8981\u5148\u5B89\u88C5 Dataview \u63D2\u4EF6\u3002\u6CE8\u610F\uFF1A\u4E0D\u652F\u6301 DOM \u64CD\u4F5C\uFF08\u5982 dv.span\u3001dv.paragraph \u7B49\uFF09\uFF0C\u4EC5\u652F\u6301\u6570\u636E\u67E5\u8BE2\u529F\u80FD\u3002";
var command_configuration2 = "\u81EA\u5B9A\u4E49\u547D\u4EE4";
var command_configuration_desc2 = "\u81EA\u5B9A\u4E49\u6784\u5EFA\u547D\u4EE4\uFF0C\u9ED8\u8BA4\u4F7F\u7528 VitePress\uFF0C\u4E5F\u53EF\u4EE5\u66FF\u6362\u4E3A Hugo\u3001Hexo \u7B49\u5176\u4ED6\u9759\u6001\u7AD9\u70B9\u751F\u6210\u5668\u3002\u4E0D\u719F\u6089\u547D\u4EE4\u884C\u7684\u7528\u6237\u8BF7\u4FDD\u6301\u9ED8\u8BA4\u8BBE\u7F6E\u3002";
var vitepress_commands2 = "\u81EA\u5B9A\u4E49\u547D\u4EE4\u8BBE\u7F6E";
var dev_command2 = "Dev\u547D\u4EE4";
var dev_command_desc2 = "\u542F\u52A8\u672C\u5730\u9884\u89C8\u670D\u52A1\u5668\u7684\u547D\u4EE4\u3002\u9ED8\u8BA4\uFF1Anpm run docs:dev";
var build_command2 = "Build\u547D\u4EE4";
var build_command_desc2 = "\u751F\u6210\u9759\u6001\u7F51\u7AD9\u6587\u4EF6\u7684\u547D\u4EE4\uFF0C\u7528\u4E8E\u90E8\u7F72\u5230\u670D\u52A1\u5668\u3002\u9ED8\u8BA4\uFF1Anpm run docs:build";
var preview_command2 = "Preview\u547D\u4EE4";
var preview_command_desc2 = "\u9884\u89C8\u5DF2\u6784\u5EFA\u7F51\u7AD9\u7684\u547D\u4EE4\uFF0C\u7528\u4E8E\u53D1\u5E03\u524D\u68C0\u67E5\u3002\u9ED8\u8BA4\uFF1Anpm run docs:preview";
var command_support_desc2 = "\u652F\u6301\u5176\u4ED6\u9759\u6001\u7AD9\u70B9\u751F\u6210\u5668\u3002\u8BF7\u63D0\u4F9B\u5B8C\u6574\u7684\u53EF\u6267\u884C\u6587\u4EF6\u8DEF\u5F84\u548C\u53C2\u6570\u3002\n\u793A\u4F8B\uFF1A\n\u2022 Hugo: /opt/homebrew/bin/hugo serve\n\u2022 Hexo: npx hexo server\n\u2022 Docusaurus: npm start";
var zh_cn_default = {
  "basic-setting": basic_setting2,
  "folder-setting": folder_setting2,
  "publish-setting": publish_setting2,
...
var ObsidianPlugin = class extends import_obsidian5.Plugin {
  ...
  async onload() {
    ...
    this.addCommand({
      id: "vitepress-build",
      name: "VitePress Build (default: npm run docs:build, configurable)",
      callback: async () => {
        await this.vitePressCmd.build();
      }
    });
    this.addCommand({
      id: "vitepress-preview",
      name: "VitePress Preview (default: npm run docs:preview, configurable)",
      callback: () => {
