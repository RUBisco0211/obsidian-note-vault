...
> [!important] 说明
> - 变量之间的依赖关系：$\text{metrics} \to \pi \to \theta$ 故可以通过优化metrics函数来得到最优的参数$\theta$
> - 难点：metrics可以在discounted case和undiscounted case中定义，即$\gamma \in [0,1)$或者$\gamma = 1$的两种情况
