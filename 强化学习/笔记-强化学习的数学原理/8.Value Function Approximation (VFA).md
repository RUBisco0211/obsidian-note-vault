---
title: 8.Value Function Approximation (VFA)
created: 2025-07-05 09:27:26
updated: 2026-01-16 17:04:59
aliases:
  - 值函数近似
---
## 从离散表示到连续表示
...
其中$P_{\pi}$为策略$\pi$下MDP的[[2.Bellman Equation#^StateTransferMatrix|状态转移矩阵]]，$[P_{\pi}]_{ij} = p_{\pi}\{ s'=s_{j} | s=s_{i} \}$
...
> 把$e_{s}$代入**TD-Linear**，即为[[7.Temporal-Difference Learning（TD learning）#TD Basic：学习状态值|TD Basic方法]]（仅更新$s_{t}$的状态值，其他不变）
> 
